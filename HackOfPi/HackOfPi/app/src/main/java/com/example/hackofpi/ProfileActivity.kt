...
class ProfileActivity : BaseActivity()
{
    ...
    private lateinit var mUserDetails: com.example.hackofpi.model.User
    ...
    {
        val toolbar_my_profile_activity : Toolbar
     ...
     */
    fun setUserDataInUI(user: com.example.hackofpi.model.User)
    {
        ...
        if (user.contact != 0L) {
            et_contact1_profile.setText(user.contact.toString())
            pcontact1 = user.contact.toString()
        }
    ...
    private fun updateUserProfileData()
    {
        ...
        if (et_contact1_profile.text.toString() != mUserDetails.contact.toString()) {

            userHashMap[Constants.Contact1] = et_contact1_profile.text.toString().toLong()
            pcontact1 = et_contact1_profile.text.toString()
        }
